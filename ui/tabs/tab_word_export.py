...
class TabWordExport(QWidget):
    """Word-exporttab (Tab 4C)."""
    ...
    def _build(self) -> None:
        ...
        self._output_edit.setPlaceholderText('Pad naar uitvoer .docx…')
        ...
        self._export_btn = QPushButton('Exporteer naar Word')
